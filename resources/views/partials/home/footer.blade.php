      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10 mb-8 md:mb-10">
        ...
        <div>
          ...
          <ul class="space-y-2 md:space-y-3 text-xs md:text-sm text-white/70 mt-5">
            ...
            @if($navAvailability['media'])<li><a href="{{ route('home_pages.media.index') }}" class="hover:text-[var(--gold)] transition flex items-center gap-2"><i class="ri-arrow-left-s-line rtl:inline ltr:hidden text-xs text-[var(--gold)]"></i><i class="ri-arrow-right-s-line ltr:inline rtl:hidden text-xs text-[var(--gold)]"></i> {{ __('home.nav.media') }}</a></li>@endif
