...
<nav
  @if($floating)
    ...
    :class="scrolled ? 'top-4 md:top-5 bg-[rgba(17,25,29,0.26)] border-white/25 shadow-black/15' : 'top-16 md:top-[4.5rem] bg-[rgba(17,25,29,0.26)] border-white/25 shadow-black/15'"
  @endif
