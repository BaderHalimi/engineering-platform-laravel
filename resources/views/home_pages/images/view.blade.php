...
<style>
    ...
    .title-row h1 { font-family: 'Cairo', sans-serif; font-weight: 800; font-size: 26px; color: var(--ink); margin: 0; }
    ...
    .stat span.num { font-family: 'Cairo', sans-serif; font-weight: 800; color: var(--ink); }
